...
2. `apps/web/lib/api.ts` forsøker å hente data fra FastAPI på `http://localhost:8000`.
3. Hvis API-et ikke svarer, bruker frontend seed-data fra `apps/web/lib/seed.ts`.
