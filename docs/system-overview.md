...
3. Hvis API-URL mangler eller API-et ikke svarer, bruker frontend det innpakkede OpenFootball-snapshotet og lokale modelldata.
...
6. Kampdata hentes periodisk fra OpenFootball, normaliseres i backend og kan suppleres med en egen liveleverandør.
...
flowchart LR
  ...
  Client -.->|snapshot når API mangler| WebSeed["apps/web/lib/data/matches.json"]
  ...
  Providers["OpenFootball, FIFA, Elo, World Bank, StatsBomb, NRK/TV 2, live-provider"] -.-> Ingest["apps/api/app/commands/ingest.py"]
  Ingest -.-> Raw["data/raw"]
