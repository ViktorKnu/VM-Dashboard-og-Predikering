...
- `GET /data/status` viser om frontend bruker seed fallback eller konfigurerte eksterne kilder.
...
Konfigurerte leverandørresponser caches før normalisering. Hvis en leverandør feiler, kan API-et fortsatt servere seed fallback eller siste cachede payload.
