...
TEAMS = [
    team(1, "Norway", "NOR", "UEFA", "no", 29, 1528.0, 1810, 87962, 5_500_000, 0.76, 0.18),
    team(2, "France", "FRA", "UEFA", "fr", 3, 1838.0, 2048, 44461, 68_000_000, 0.92, 0.92),
    team(3, "Senegal", "SEN", "CAF", "sn", 19, 1609.0, 1802, 1598, 17_700_000, 0.88, 0.34),
    team(4, "Iraq", "IRQ", "AFC", "iq", 58, 1410.3, 1640, 5937, 45_500_000, 0.84, 0.08),
    team(5, "Argentina", "ARG", "CONMEBOL", "ar", 2, 1860.0, 2108, 13730, 46_000_000, 0.97, 1.0),
    team(6, "Algeria", "ALG", "CAF", "dz", 35, 1512.0, 1735, 5260, 46_000_000, 0.9, 0.3),
    team(7, "Austria", "AUT", "UEFA", "at", 24, 1546.0, 1815, 56000, 9_100_000, 0.82, 0.42),
    team(8, "Jordan", "JOR", "AFC", "jo", 66, 1375.0, 1555, 4311, 11_500_000, 0.77, 0.02),
    team(9, "Portugal", "POR", "UEFA", "pt", 6, 1748.1, 1975, 27405, 10_400_000, 0.95, 0.62),
    team(10, "DR Congo", "COD", "CAF", "cd", 56, 1420.0, 1648, 715, 105_000_000, 0.86, 0.08),
    team(11, "Uzbekistan", "UZB", "AFC", "uz", 50, 1455.0, 1662, 2496, 36_400_000, 0.72, 0.02),
    team(12, "Colombia", "COL", "CONMEBOL", "co", 13, 1685.0, 1905, 6979, 52_000_000, 0.94, 0.45),
    team(13, "England", "ENG", "UEFA", "gb-eng", 4, 1813.0, 2030, 48900, 57_000_000, 0.96, 0.84),
    team(14, "Croatia", "CRO", "UEFA", "hr", 10, 1710.0, 1900, 21460, 3_900_000, 0.91, 0.82),
    team(15, "Ghana", "GHA", "CAF", "gh", 72, 1350.0, 1610, 2238, 34_000_000, 0.89, 0.34),
    team(16, "Panama", "PAN", "CONCACAF", "pa", 30, 1525.0, 1665, 18490, 4_500_000, 0.74, 0.08),
]
...
MATCHES = [
    ...
    match(3, "I", 1, 3, "2026-06-22T19:00:00+00:00", "New York New Jersey Stadium", "New York/New Jersey"),
    match(4, "I", 2, 4, "2026-06-22T22:00:00+00:00", "Philadelphia Stadium", "Philadelphia"),
    ...
    match(9, "J", 5, 7, "2026-06-22T19:00:00+00:00", "Dallas Stadium", "Dallas"),
    match(10, "J", 8, 6, "2026-06-22T22:00:00+00:00", "San Francisco Bay Area Stadium", "San Francisco Bay Area"),
    match(11, "J", 6, 7, "2026-06-27T19:00:00+00:00", "Kansas City Stadium", "Kansas City"),
    match(12, "J", 8, 5, "2026-06-27T19:00:00+00:00", "Dallas Stadium", "Dallas"),
    match(13, "K", 9, 10, "2026-06-17T19:00:00+00:00", "Houston Stadium", "Houston", "finished", 1, 1),
    match(14, "K", 9, 11, "2026-06-23T19:00:00+00:00", "Houston Stadium", "Houston"),
    match(15, "K", 12, 10, "2026-06-23T22:00:00+00:00", "Estadio Guadalajara", "Guadalajara"),
    match(16, "K", 12, 9, "2026-06-27T19:00:00+00:00", "Miami Stadium", "Miami"),
    match(17, "K", 10, 11, "2026-06-27T19:00:00+00:00", "Atlanta Stadium", "Atlanta"),
    match(18, "L", 13, 14, "2026-06-17T20:00:00+00:00", "Dallas Stadium", "Dallas", "finished", 4, 2),
    match(19, "L", 13, 15, "2026-06-23T19:00:00+00:00", "Boston Stadium", "Boston"),
    match(20, "L", 16, 14, "2026-06-23T22:00:00+00:00", "Toronto Stadium", "Toronto"),
    match(21, "L", 16, 13, "2026-06-27T19:00:00+00:00", "New York New Jersey Stadium", "New York/New Jersey"),
    match(22, "L", 14, 15, "2026-06-27T19:00:00+00:00", "Philadelphia Stadium", "Philadelphia"),
]
